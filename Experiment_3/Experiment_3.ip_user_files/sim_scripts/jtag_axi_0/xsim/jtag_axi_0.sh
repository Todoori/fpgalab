...
#
# Script generated by Vivado on Wed Jun 25 12:09:06 +0200 2025
...
# script info
echo -e "jtag_axi_0.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L jtag_axi -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot jtag_axi_0 xil_defaultlib.jtag_axi_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim jtag_axi_0 -key {Behavioral:sim_1:Functional:jtag_axi_0} -tclbatch cmd.tcl -protoinst "protoinst_files/JTAG.protoinst" -log simulate.log
}
