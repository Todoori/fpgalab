...
HD_PWD='C:/Users/moham/Desktop/Fpga/Experiment_3/Experiment_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_axi_JTAG_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source uart_axi_JTAG_wrapper.tcl -notrace
