...
HD_PWD='C:/Users/moham/Desktop/Fpga/Experiment_3/Experiment_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_axi_JTAG_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_axi_JTAG_wrapper.tcl
